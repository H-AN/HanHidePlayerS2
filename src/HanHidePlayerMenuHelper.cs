...
public class HanHidePlayerMenuHelper
{
    private readonly ILogger<HanHidePlayerMenuHelper> _logger;
    private readonly ISwiftlyCore _core;

    public HanHidePlayerMenuHelper(ISwiftlyCore core, ILogger<HanHidePlayerMenuHelper> logger)
    {
        _core = core;
        _logger = logger;
    }
